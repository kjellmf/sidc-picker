  ...
  <v-container>
    <v-layout>
      <v-flex
        ...
        <p>Thanks to <a href="https://spatialillusions.com/">Måns Beckman</a> for publishing the
          <a href="https://spatialillusions.com/milsymbol/index.html">milsymbol</a> and <a
          href="https://github.com/spatialillusions/milstd">milstd</a> libraries
          as open source! Check out his <a href="https://spatialillusions.com/unitgenerator.html">Unit Symbol
          Generator</a>
          if you need a more customizable online symbol generator. </p>

        <p>Thanks to <a href="https://www.esri.com/en-us/about/about-esri">Esri</a> for publishing and maintaining the
          <a
            href="https://github.com/Esri/joint-military-symbology-xml"> Joint Military Symbology Markup Language
            (JMSML)
        ...
        <p>The SIDC picker was originally written as part of a larger application. Useful in its own right, it was
        extracted
        into a standalone component for easier reuse.

        </p><p>Some of the tools, frameworks and libraries used:</p>
        <ul class="ml-4">
